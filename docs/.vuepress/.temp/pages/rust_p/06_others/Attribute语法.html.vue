<template><div><p>让我为你详细介绍 Rust 的 <strong>Attribute（属性）</strong> 语法。</p>
<p>[2 tools called]</p>
<h1 id="rust-attribute-属性-语法完整指南" tabindex="-1"><a class="header-anchor" href="#rust-attribute-属性-语法完整指南"><span>Rust Attribute（属性）语法完整指南</span></a></h1>
<h2 id="一、什么是-attribute" tabindex="-1"><a class="header-anchor" href="#一、什么是-attribute"><span><strong>一、什么是 Attribute？</strong></span></a></h2>
<p>Attribute 是 Rust 的元数据注解，用于：</p>
<ul>
<li>控制编译器行为</li>
<li>自动生成代码</li>
<li>配置条件编译</li>
...
<h2 id="二、基本语法" tabindex="-1"><a class="header-anchor" href="#二、基本语法"><span><strong>二、基本语法</strong></span></a></h2>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 1. 外部属性 - 作用于下一个项目</span></span>
...
<h3 id="_1-derive-自动实现-trait" tabindex="-1"><a class="header-anchor" href="#_1-derive-自动实现-trait"><span><strong>1. <code v-pre>#[derive(...)]</code> - 自动实现 trait</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 从你的项目中：</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常见的派生 trait：</p>
<ul>
<li><code v-pre>Debug</code> - 调试打印（<code v-pre>{:?}</code>）</li>
<li><code v-pre>Clone</code> - 克隆能力</li>
<li><code v-pre>Copy</code> - 按位复制</li>
<li><code v-pre>PartialEq</code> / <code v-pre>Eq</code> - 相等比较</li>
<li><code v-pre>PartialOrd</code> / <code v-pre>Ord</code> - 排序比较</li>
<li><code v-pre>Default</code> - 默认值</li>
<li><code v-pre>Hash</code> - 哈希能力</li>
</ul>
<h3 id="_2-cfg-条件编译" tabindex="-1"><a class="header-anchor" href="#_2-cfg-条件编译"><span><strong>2. <code v-pre>#[cfg(...)]</code> - 条件编译</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 仅在测试时编译</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-test-测试函数" tabindex="-1"><a class="header-anchor" href="#_3-test-测试函数"><span><strong>3. <code v-pre>#[test]</code> - 测试函数</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token attribute attr-name">#[test]</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-allow-warn-deny-控制-lint" tabindex="-1"><a class="header-anchor" href="#_4-allow-warn-deny-控制-lint"><span><strong>4. <code v-pre>#[allow(...)]</code> / <code v-pre>#[warn(...)]</code> / <code v-pre>#[deny(...)]</code> - 控制 lint</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 允许未使用的变量</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-deprecated-标记废弃" tabindex="-1"><a class="header-anchor" href="#_5-deprecated-标记废弃"><span><strong>5. <code v-pre>#[deprecated]</code> - 标记废弃</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token attribute attr-name">#[deprecated(since = <span class="token string">"1.0.0"</span>, note = <span class="token string">"请使用 new_function 代替"</span>)]</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-inline-内联提示" tabindex="-1"><a class="header-anchor" href="#_6-inline-内联提示"><span><strong>6. <code v-pre>#[inline]</code> - 内联提示</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 建议内联</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、第三方库的-attribute" tabindex="-1"><a class="header-anchor" href="#四、第三方库的-attribute"><span><strong>四、第三方库的 Attribute</strong></span></a></h2>
<h3 id="_1-serde-序列化-反序列化" tabindex="-1"><a class="header-anchor" href="#_1-serde-序列化-反序列化"><span><strong>1. Serde - 序列化/反序列化</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 从你的项目中：</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常用 serde 属性：</p>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token attribute attr-name">#[serde(rename = <span class="token string">"newName"</span>)]</span>           <span class="token comment">// 重命名字段</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-thiserror-错误处理" tabindex="-1"><a class="header-anchor" href="#_2-thiserror-错误处理"><span><strong>2. Thiserror - 错误处理</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 从你的项目中：</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-uniffi-跨语言绑定" tabindex="-1"><a class="header-anchor" href="#_3-uniffi-跨语言绑定"><span><strong>3. UniFFI - 跨语言绑定</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token attribute attr-name">#[derive(uniffi::Record)]</span>  <span class="token comment">// 生成 FFI 绑定</span></span>
<span class="line"><span class="token keyword">pub</span> <span class="token keyword">struct</span> <span class="token type-definition class-name">DexSummaryDetail</span> <span class="token punctuation">{</span></span>
<span class="line">    <span class="token keyword">pub</span> summary<span class="token punctuation">:</span> <span class="token class-name">Option</span><span class="token operator">&lt;</span><span class="token class-name">String</span><span class="token operator">></span><span class="token punctuation">,</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-tokio-异步运行时" tabindex="-1"><a class="header-anchor" href="#_4-tokio-异步运行时"><span><strong>4. Tokio - 异步运行时</strong></span></a></h3>
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token comment">// 异步测试</span></span>
...
<div class="language-rust line-numbers-mode" data-highlighter="prismjs" data-ext="rs"><pre v-pre><code><span class="line"><span class="token keyword">use</span> <span class="token namespace">serde<span class="token punctuation">::</span></span><span class="token punctuation">{</span><span class="token class-name">Deserialize</span><span class="token punctuation">,</span> <span class="token class-name">Serialize</span><span class="token punctuation">}</span><span class="token punctuation">;</span></span>
